...
<body class="hold-transition sidebar-mini layout-fixed">
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<section class="col-lg-12 connectedSortable">
									...
									<div class="row">
										...
										<div class="col-md-5">
											<button class="btn pull-right"
												...
												id="InspectionRateList">Inspection Rate List</button>
										</div>
										<div class="col-md-3">
											<h5>Category</h5>
										</div>
										...
										<div class="col-md-2">
											<button class="btn pull-right"
												style="background-color: #007bff; color: white;"
												id="addInspectionRate">Add Inspection Rate</button>
									...
									<tbody>
										<c:forEach items="${list}" var="item">
											<tr>
												...
												<td><a
													onclick="editInspectionRate(${item.id},'${item.serviceName}',${item.rate});"><i
														class="fa fa-pencil-alt" style="color: #007bff;"></i></a>&emsp;<a
													onclick="deleteInspectionRate(${item.id});"><i
							...
							<div class="row card-body" id="addInspectionRateDiv"
								style="display: none;">
								<!-- left column -->
								<div class="col-md-12">
									...
									<div class="card card-primary">
										...
										<!-- /.card-header -->
										<!-- form start -->
										<form:form role="form" action="/addInspectionRate"
											method="post">
											<div class="card-body">
												...
												<div class="row">
													<div class="form-group col-md-4">
														...
														<form:input path="serviceName" class="form-control"
															id="name" placeholder="Enter Service Name" />
														<form:errors path="serviceName"></form:errors>
														<input type="hidden" id="id" name="id">
													</div>

													<div class="form-group col-md-4">
														<label for="exampleInputEmail1">Inspection Rate</label>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title">Delete Inspection Rate</h4>
								...
								<div class="modal-body">
									<p>Are You Sure You Want To Delete Inspection Rate?&hellip;</p>
								</div>
								...
								<div class="modal-footer justify-content-between">
									...
									<button type="button" class="btn btn-primary"
										id="deleteInspectionRate">Yes</button>
								</div>
							</div>
							<!-- /.modal-content -->
						</div>
	...
	<script type="text/javascript" src="CustomJs/inspectionRate.js"></script>
