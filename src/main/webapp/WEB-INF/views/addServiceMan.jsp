                                        ...
                                        <%-- <form action="addServiceMan" method="post" class="form-horizontal"> --%>
                                            <div class="row form-group">
                                                ...
                                                <label class="control-label mb-1">Service Man Name</label>
                                                    <input type="text" name="serviceName" placeholder="name" class="form-control">
                                                </div>
                                                <div class="col col-md-6">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <label class="control-label mb-1">Address Line 1</label>
                                                    <input type="text" name="address.addressLine1" placeholder="address line 1" class="form-control">
                                                </div>
                                                <div class="col col-md-6">
                                                <label class="control-label mb-1">Address Line 2</label>
                                                    <input type="text" name="address.addressLine2" placeholder="address line 2" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-6">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <label class="control-label mb-1">Experience</label>
                                                    <input type="text" name="experience" placeholder="experience in year" class="form-control">
                                                </div>
                                                <div class="col col-md-6">
                                                   <label class="control-label mb-1">Minimun Charges</label>
                                                    <input type="text" name="inspectionCharge" placeholder="minimum charges in Rs" class="form-control" >
                                                </div>
                                            </div>
                                       <%--  </form> --%>
                                    </div>
