...
<div class="ml-auto">
										<div class="dl">
											 <span class="nav-item search-box"> <a class="nav-link waves-effect waves-dark" onkeyup="myName()" ><i class="ti-search"></i></a>
								 		<div class="app-search position-absolute">
											<input type="text" id="myInput" class="form-control" placeholder="Search for name" onkeyup="myName()"> <a class="srh-btn"><i class="ti-close"></i></a>
										</div>  
										</span>																													
